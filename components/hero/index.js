                            ...
                            <div className="col-xl-8 col-lg-6 col-12">
                                <div className="wpo-static-hero-inner">
                                    ...
                                    <div data-swiper-parallax="400" className="slide-text">
                                        <h1 className='Gusaba'>The Parents of Laura Uzamukunda & Olivier Nsengiyumva would love your presence to our Traditional Rwandan Wedding: Gusaba na Gukwa</h1>
                                    </div>
